    ...
    <nav className="bg-[#0A0A0A] text-white shadow-2xl sticky top-0 z-50 border-b-2 border-[#D4AF37]">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {userName ? (
              ...
              <Button
                ...
                className="ml-4 bg-gradient-to-r from-[#D4AF37] to-[#B8941F] hover:from-[#7B1E26] hover:to-[#7B1E26] text-[#0A0A0A] hover:text-white px-6 py-2 h-auto transition-all"
              >
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-[#D4AF37] hover:bg-[#4A3B2A]"
            >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden px-2 pt-2 pb-3 space-y-1">
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 w-full px-3 py-3 rounded-lg text-base font-medium transition-all ${
                  isActive
                    ? "bg-[#D4AF37] text-[#0A0A0A]"
                    : "text-[#E0E0E0] hover:bg-[#4A3B2A] hover:text-[#D4AF37]"
                }`}
          ...
          {/* User Menu Móvil */}
          {userName ? (
            <div className="pt-4 pb-3 border-t border-[#4A3B2A]">
              ...
              <Button
                ...
                className="mt-2 w-full justify-start gap-3 bg-transparent text-[#E0E0E0] hover:bg-[#4A3B2A] hover:text-[#D4AF37] border border-transparent font-medium px-3 py-3 text-base"
              >
            ...
            <Button
              ...
              className="mt-2 w-full justify-start gap-3 bg-gradient-to-r from-[#D4AF37] to-[#B8941F] hover:from-[#7B1E26] hover:to-[#7B1E26] text-[#0A0A0A] hover:text-white px-3 py-3 text-base font-medium"
            >
